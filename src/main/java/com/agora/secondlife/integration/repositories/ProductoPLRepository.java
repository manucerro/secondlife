...
import com.agora.secondlife.integration.model.FamiliaPL;
import com.agora.secondlife.integration.model.ProductoPL;
...
public interface ProductoPLRepository extends JpaRepository<ProductoPL, Long> {
	...
	@Query("SELECT new com.agora.secondlife.business.model.dtos.ProductoDTO2(UPPER(p.nombre),YEAR(p.fechaAlta)) FROM ProductoPL p")
	List<ProductoDTO2> findDTO2();
	
	@Query("SELECT new com.agora.secondlife.business.model.dtos.ProductoDTO3( "
